...
+function (t) {
    ...
    s.VERSION = "3.2.0", s.prototype.close = function (e) {
        ...
        var a = t(n);
        e && e.preventDefault(), a.length || (a = s.hasClass("alert") ? s : s.parent()), a.trigger(e = t.Event("close.bs.alert")), e.isDefaultPrevented() || (a.removeClass("in"), t.support.transition && a.hasClass("fade") ? a.one("bsTransitionEnd", i).emulateTransitionEnd(150) : i())
    };
    var n = t.fn.alert;
    ...
    function e(e) {
        return this.each(function () {
            var s = t(this), n = s.data("bs.button"), a = "object" == typeof e && e;
            n || s.data("bs.button", n = new i(this, a)), "toggle" == e ? n.toggle() : e && n.setState(e)
        })
    }
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {loadingText: "loading..."}, i.prototype.setState = function (e) {
        var i = "disabled", s = this.$element, n = s.is("input") ? "val" : "html", a = s.data();
        e += "Text", null == a.resetText && s.data("resetText", s[n]()), s[n](null == a[e] ? this.options[e] : a[e]), setTimeout(t.proxy(function () {
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {interval: 5e3, pause: "hover", wrap: !0}, i.prototype.keydown = function (t) {
        ...
        var s = this.$element.find(".item.active"), n = i || s[e](), a = this.interval,
        ...
        var h = n[0], d = t.Event("slide.bs.carousel", {relatedTarget: h, direction: o});
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            return t.support.transition && this.$element.hasClass("slide") ? (n.addClass(e), n[0].offsetWidth, s.addClass(o), n.addClass(o), s.one("bsTransitionEnd", function () {
                n.removeClass([e, o].join(" ")).addClass("active"), s.removeClass(["active", o].join(" ")), l.sliding = !1, setTimeout(function () {
                    l.$element.trigger(u)
                }, 0)
            }).emulateTransitionEnd(1e3 * s.css("transition-duration").slice(0, -1))) : (s.removeClass("active"), n.addClass("active"), this.sliding = !1, this.$element.trigger(u)), a && this.cycle(), this
        }
    };
    var s = t.fn.carousel;
    t.fn.carousel = e, t.fn.carousel.Constructor = i, t.fn.carousel.noConflict = function () {
        ...
        if (a.hasClass("carousel")) {
            var o = t.extend({}, a.data(), n.data()), r = n.attr("data-slide-to");
    ...
    function e(e) {
        return this.each(function () {
            var s = t(this), n = s.data("bs.collapse"),
                a = t.extend({}, i.DEFAULTS, s.data(), "object" == typeof e && e);
            !n && a.toggle && "show" == e && (e = !e), n || s.data("bs.collapse", n = new i(this, a)), "string" == typeof e && n[e]()
        })
    }
    ...
    t.fn.collapse = e, t.fn.collapse.Constructor = i, t.fn.collapse.noConflict = function () {
        ...
        var s, n = t(this),
            a = n.attr("data-target") || i.preventDefault() || (s = n.attr("href")) && s.replace(/.*(?=#[^\s]+$)/, ""),
            o = t(a), r = o.data("bs.collapse"), l = r ? "toggle" : n.data(), h = n.attr("data-parent"), d = h && t(h);
    ...
    var n = ".dropdown-backdrop", a = '[data-toggle="dropdown"]', o = function (e) {
        t(e).on("click.bs.dropdown", this.toggle)
    };
    o.VERSION = "3.2.0", o.prototype.toggle = function (s) {
        var n = t(this);
        ...
        if (/(38|40|27)/.test(e.keyCode)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !s.is(".disabled, :disabled")) {
                var n = i(s), o = n.hasClass("open");
                if (!o || o && 27 == e.keyCode) return 27 == e.which && n.find(a).trigger("focus"), s.trigger("click");
    ...
    function e(e, s) {
        return this.each(function () {
            var n = t(this), a = n.data("bs.modal"), o = t.extend({}, i.DEFAULTS, n.data(), "object" == typeof e && e);
            a || n.data("bs.modal", a = new i(this, o)), "string" == typeof e ? a[e](s) : o.show && a.show(s)
        })
    }
    ...
    t.fn.modal = e, t.fn.modal.Constructor = i, t.fn.modal.noConflict = function () {
        ...
        var s = t(this), n = s.attr("href"), a = t(s.attr("data-target") || n && n.replace(/.*(?=#[^\s]+$)/, "")),
            o = a.data("bs.modal") ? "toggle" : t.extend({remote: !/#/.test(n) && n}, a.data(), s.data());
        s.is("a") && i.preventDefault(), a.one("show.bs.modal", function (t) {
    ...
    function e(e) {
        return this.each(function () {
            var s = t(this), n = s.data("bs.tooltip"), a = "object" == typeof e && e;
            (n || "destroy" != e) && (n || s.data("bs.tooltip", n = new i(this, a)), "string" == typeof e && n[e]())
        })
    }
    ...
    i.VERSION = "3.2.0", i.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            var h = this.getPosition(), d = n[0].offsetWidth, c = n[0].offsetHeight;
            if (l) {
                var u = o, p = this.$element.parent(), m = this.getPosition(p);
                o = "bottom" == o && h.top + h.height + c - m.scroll > m.height ? "top" : "top" == o && h.top - m.scroll - c < 0 ? "bottom" : "right" == o && h.right + d > m.width ? "left" : "left" == o && h.left - d < m.left ? "right" : o, n.removeClass(u).addClass(o)
            }
            var f = this.getCalculatedOffset(o, h, d, c);
        ...
        var s = this.tip(), n = s[0].offsetWidth, a = s[0].offsetHeight, o = parseInt(s.css("margin-top"), 10),
            r = parseInt(s.css("margin-left"), 10);
        isNaN(o) && (o = 0), isNaN(r) && (r = 0), e.top = e.top + o, e.left = e.left + r, t.offset.setOffset(s[0], t.extend({
            using: function (t) {
        ...
        var c = d.left ? 2 * d.left - n + l : 2 * d.top - a + h, u = d.left ? "left" : "top",
            p = d.left ? "offsetWidth" : "offsetHeight";
        s.offset(e), this.replaceArrow(c, s[0][p], u)
        ...
        if (/right|left/.test(t)) {
            var r = e.top - a - o.scroll, l = e.top + a - o.scroll + s;
            r < o.top ? n.top = o.top - r : l > o.top + o.height && (n.top = o.top + o.height - l)
        } else {
            var h = e.left - a, d = e.left + a + i;
    ...
    function e(e) {
        return this.each(function () {
            var s = t(this), n = s.data("bs.popover"), a = "object" == typeof e && e;
            (n || "destroy" != e) && (n || s.data("bs.popover", n = new i(this, a)), "string" == typeof e && n[e]())
        })
    }
    ...
    function i(i) {
        return this.each(function () {
            var s = t(this), n = s.data("bs.scrollspy"), a = "object" == typeof i && i;
    ...
    e.VERSION = "3.2.0", e.DEFAULTS = {offset: 10}, e.prototype.getScrollHeight = function () {
        ...
        this.$body.find(this.selector).map(function () {
            var s = t(this), n = s.data("target") || s.attr("href"), a = /^#./.test(n) && t(n);
        ...
        var t, e = this.$scrollElement.scrollTop() + this.options.offset, i = this.getScrollHeight(),
            s = this.options.offset + i - this.$scrollElement.height(), n = this.offsets, a = this.targets,
            o = this.activeTarget;
    ...
    i.VERSION = "3.2.0", i.prototype.show = function () {
        ...
        if (s || (s = e.attr("href"), s = s && s.replace(/.*(?=#[^\s]*$)/, "")), !e.parent("li").hasClass("active")) {
            var n = i.find(".active:last a")[0], a = t.Event("show.bs.tab", {relatedTarget: n});
        ...
        function n() {
            a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active"), e.addClass("active"), o ? (e[0].offsetWidth, e.addClass("in")) : e.removeClass("fade"), e.parent(".dropdown-menu") && e.closest("li.dropdown").addClass("active"), s && s()
        }

        var a = i.find("> .active"), o = s && t.support.transition && a.hasClass("fade");
    ...
    function e(e) {
        return this.each(function () {
            var s = t(this), n = s.data("bs.affix"), a = "object" == typeof e && e;
    ...
    i.VERSION = "3.2.0", i.RESET = "affix affix-top affix-bottom", i.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var e = t(document).height(), s = this.$target.scrollTop(), n = this.$element.offset(),
                a = this.options.offset, o = a.top, r = a.bottom;
            "object" != typeof a && (r = o = a), "function" == typeof o && (o = a.top(this.$element)), "function" == typeof r && (r = a.bottom(this.$element));
            var l = null != this.unpin && s + this.unpin <= n.top ? !1 : null != r && n.top + this.$element.height() >= e - r ? "bottom" : null != o && o >= s ? "top" : !1;
            if (this.affixed !== l) {
                null != this.unpin && this.$element.css("top", "");
                var h = "affix" + (l ? "-" + l : ""), d = t.Event(h + ".bs.affix");
                this.$element.trigger(d), d.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(i.RESET).addClass(h).trigger(t.Event(h.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({top: e - this.$element.height() - r}))
            }
        }
    };
    var s = t.fn.affix;
    ...
    t.flexslider = function (e, i) {
        ...
        var n, a = s.vars.namespace, o = window.navigator && window.navigator.msPointerEnabled && window.MSGesture,
            r = ("ontouchstart" in window || o || window.DocumentTouch && document instanceof DocumentTouch) && s.vars.touch,
            l = "click touchend MSPointerUp keyup", h = "", d = "vertical" === s.vars.direction, c = s.vars.reverse,
            u = s.vars.itemWidth > 0, p = "fade" === s.vars.animation, m = "" !== s.vars.asNavFor, f = {}, v = !0;
        t.data(e, "flexslider", s), f = {
            init: function () {
                s.animating = !1, s.currentSlide = parseInt(s.vars.startAt ? s.vars.startAt : 0, 10), isNaN(s.currentSlide) && (s.currentSlide = 0), s.animatingTo = s.currentSlide, s.atEnd = 0 === s.currentSlide || s.currentSlide === s.last, s.containerSelector = s.vars.selector.substr(0, s.vars.selector.search(" ")), s.slides = t(s.vars.selector, s), s.container = t(s.containerSelector, s), s.count = s.slides.length, s.syncExists = t(s.vars.sync).length > 0, "slide" === s.vars.animation && (s.vars.animation = "swing"), s.prop = d ? "top" : "marginLeft", s.args = {}, s.manualPause = !1, s.stopped = !1, s.started = !1, s.startTimeout = null, s.transitions = !s.vars.video && !p && s.vars.useCSS && function () {
                    var t = document.createElement("div"),
                ...
                }), s.container.empty().append(s.slides)), s.doMath(), s.setup("init"), s.vars.controlNav && f.controlNav.setup(), s.vars.directionNav && f.directionNav.setup(), s.vars.keyboard && (1 === t(s.containerSelector).length || s.vars.multipleKeyboard) && t(document).bind("keyup", function (t) {
                    var e = t.keyCode;
                    ...
                    s.flexAnimate(i, s.vars.pauseOnAction)
                }), s.vars.pausePlay && f.pausePlay.setup(), s.vars.slideshow && s.vars.pauseInvisible && f.pauseInvisible.init(), s.vars.slideshow && (s.vars.pauseOnHover && s.hover(function () {
                    s.manualPlay || s.manualPause || s.pause()
                }, function () {
                    s.manualPause || s.manualPlay || s.stopped || s.play()
                }), s.vars.pauseInvisible && f.pauseInvisible.isHidden() || (s.vars.initDelay > 0 ? s.startTimeout = setTimeout(s.play, s.vars.initDelay) : s.play())), m && f.asNav.setup(), r && s.vars.touch && f.touch(), (!p || p && s.vars.smoothHeight) && t(window).bind("resize orientationchange focus", f.resize), s.find("img").attr("draggable", "false"), setTimeout(function () {
                    s.vars.start(s)
                }, 200)
            }, asNav: {
                setup: function () {
                    s.asNav = !0, s.animatingTo = Math.floor(s.currentSlide / s.move), s.currentItem = s.currentSlide, s.slides.removeClass(a + "active-slide").eq(s.currentItem).addClass(a + "active-slide"), o ? (e._slider = s, s.slides.each(function () {
                        var e = this;
                        ...
                        e.preventDefault();
                        var i = t(this), n = i.index(), o = i.offset().left - t(s).scrollLeft();
                        0 >= o && i.hasClass(a + "active-slide") ? s.flexAnimate(s.getTarget("prev"), !0) : t(s.vars.asNavFor).data("flexslider").animating || i.hasClass(a + "active-slide") || (s.direction = s.currentItem < n ? "next" : "prev", s.flexAnimate(n, s.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            }, controlNav: {
                setup: function () {
                    s.manualControls ? f.controlNav.setupManual() : f.controlNav.setupPaging()
                }, setupPaging: function () {
                    var e, i, n = "thumbnails" === s.vars.controlNav ? "control-thumbs" : "control-paging", o = 1;
                    if (s.controlNavScaffold = t('<ol class="' + a + "control-nav " + a + n + '"></ol>'), s.pagingCount > 1) for (var r = 0; r < s.pagingCount; r++) {
                        if (i = s.slides.eq(r), e = "thumbnails" === s.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"/>' : "<a>" + o + "</a>", "thumbnails" === s.vars.controlNav && !0 === s.vars.thumbCaptions) {
                            var d = i.attr("data-thumbcaption");
                            "" != d && void 0 != d && (e += '<span class="' + a + 'caption">' + d + "</span>")
                        }
                        s.controlNavScaffold.append("<li>" + e + "</li>"), o++
                    }
                    s.controlsContainer ? t(s.controlsContainer).append(s.controlNavScaffold) : s.append(s.controlNavScaffold), f.controlNav.set(), f.controlNav.active(), s.controlNavScaffold.delegate("a, img", l, function (e) {
                        ...
                        "" === h && (h = e.type), f.setToClearWatchedEvent()
                    })
                }, setupManual: function () {
                    s.controlNav = s.manualControls, f.controlNav.active(), s.controlNav.bind(l, function (e) {
                        if (e.preventDefault(), "" === h || h === e.type) {
                            var i = t(this), n = s.controlNav.index(i);
                            i.hasClass(a + "active") || (s.direction = n > s.currentSlide ? "next" : "prev", s.flexAnimate(n, s.vars.pauseOnAction))
                        }
                    ...
                    s.pagingCount > 1 && "add" === e ? s.controlNavScaffold.append(t("<li><a>" + s.count + "</a></li>")) : 1 === s.pagingCount ? s.controlNavScaffold.find("li").remove() : s.controlNav.eq(i).closest("li").remove(), f.controlNav.set(), s.pagingCount > 1 && s.pagingCount !== s.controlNav.length ? s.update(i, e) : f.controlNav.active()
                }
            }, directionNav: {
                setup: function () {
                    var e = t('<ul class="' + a + 'direction-nav"><li><a class="' + a + 'prev" href="#">' + s.vars.prevText + '</a></li><li><a class="' + a + 'next" href="#">' + s.vars.nextText + "</a></li></ul>");
                    s.controlsContainer ? (t(s.controlsContainer).append(e), s.directionNav = t("." + a + "direction-nav li a", s.controlsContainer)) : (s.append(e), s.directionNav = t("." + a + "direction-nav li a", s)), f.directionNav.update(), s.directionNav.bind(l, function (e) {
                        e.preventDefault();
                        var i;
                        ("" === h || h === e.type) && (i = s.getTarget(t(this).hasClass(a + "next") ? "next" : "prev"), s.flexAnimate(i, s.vars.pauseOnAction)), "" === h && (h = e.type), f.setToClearWatchedEvent()
                    })
                }, update: function () {
                    var t = a + "disabled";
                ...
                setup: function () {
                    ...
                    s.controlsContainer ? (s.controlsContainer.append(e), s.pausePlay = t("." + a + "pauseplay a", s.controlsContainer)) : (s.append(e), s.pausePlay = t("." + a + "pauseplay a", s)), f.pausePlay.update(s.vars.slideshow ? a + "pause" : a + "play"), s.pausePlay.bind(l, function (e) {
                        e.preventDefault(), ("" === h || h === e.type) && (t(this).hasClass(a + "pause") ? (s.manualPause = !0, s.manualPlay = !1, s.pause()) : (s.manualPause = !1, s.manualPlay = !0, s.play())), "" === h && (h = e.type), f.setToClearWatchedEvent()
                    })
                }, update: function (t) {
                ...
                function t(t) {
                    s.animating ? t.preventDefault() : (window.navigator.msPointerEnabled || 1 === t.touches.length) && (s.pause(), v = d ? s.h : s.w, y = Number(new Date), _ = t.touches[0].pageX, w = t.touches[0].pageY, f = u && c && s.animatingTo === s.last ? 0 : u && c ? s.limit - (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo : u && s.currentSlide === s.last ? s.limit : u ? (s.itemW + s.vars.itemMargin) * s.move * s.currentSlide : c ? (s.last - s.currentSlide + s.cloneOffset) * v : (s.currentSlide + s.cloneOffset) * v, h = d ? w : _, m = d ? _ : w, e.addEventListener("touchmove", i, !1), e.addEventListener("touchend", n, !1))
                }

                function i(t) {
                    _ = t.touches[0].pageX, w = t.touches[0].pageY, g = d ? h - w : h - _, b = d ? Math.abs(g) < Math.abs(_ - m) : Math.abs(g) < Math.abs(w - m);
                    var e = 500;
                    (!b || Number(new Date) - y > e) && (t.preventDefault(), !p && s.transitions && (s.vars.animationLoop || (g /= 0 === s.currentSlide && 0 > g || s.currentSlide === s.last && g > 0 ? Math.abs(g) / v + 2 : 1), s.setProps(f + g, "setTouch")))
                }

                function n() {
                    if (e.removeEventListener("touchmove", i, !1), s.animatingTo === s.currentSlide && !b && null !== g) {
                        var t = c ? -g : g, a = s.getTarget(t > 0 ? "next" : "prev");
                        s.canAdvance(a) && (Number(new Date) - y < 550 && Math.abs(t) > 50 || Math.abs(t) > v / 2) ? s.flexAnimate(a, s.vars.pauseOnAction) : p || s.flexAnimate(s.currentSlide, s.vars.pauseOnAction, !0)
                    }
                    e.removeEventListener("touchend", n, !1), h = null, m = null, g = null, f = null
                }

                function a(t) {
                    t.stopPropagation(), s.animating ? t.preventDefault() : (s.pause(), e._gesture.addPointer(t.pointerId), P = 0, v = d ? s.h : s.w, y = Number(new Date), f = u && c && s.animatingTo === s.last ? 0 : u && c ? s.limit - (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo : u && s.currentSlide === s.last ? s.limit : u ? (s.itemW + s.vars.itemMargin) * s.move * s.currentSlide : c ? (s.last - s.currentSlide + s.cloneOffset) * v : (s.currentSlide + s.cloneOffset) * v)
                }
                ...
                function r(t) {
                    ...
                    if (i) {
                        ...
                        return P += d ? n : s, g = P, b = d ? Math.abs(P) < Math.abs(-s) : Math.abs(P) < Math.abs(-n), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function () {
                            e._gesture.stop()
                        }) : void((!b || Number(new Date) - y > 500) && (t.preventDefault(), !p && i.transitions && (i.vars.animationLoop || (g = P / (0 === i.currentSlide && 0 > P || i.currentSlide === i.last && P > 0 ? Math.abs(P) / v + 2 : 1)), i.setProps(f + g, "setTouch"))))
                    }
                }
                ...
                function l(t) {
                    ...
                    if (e) {
                        if (e.animatingTo === e.currentSlide && !b && null !== g) {
                            var i = c ? -g : g, s = e.getTarget(i > 0 ? "next" : "prev");
                            e.canAdvance(s) && (Number(new Date) - y < 550 && Math.abs(i) > 50 || Math.abs(i) > v / 2) ? e.flexAnimate(s, e.vars.pauseOnAction) : p || e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0)
                        }
                        h = null, m = null, g = null, f = null, P = 0
                    }
                }

                var h, m, f, v, g, y, b = !1, _ = 0, w = 0, P = 0;
                o ? (e.style.msTouchAction = "none", e._gesture = new MSGesture, e._gesture.target = e, e.addEventListener("MSPointerDown", a, !1), e._slider = s, e.addEventListener("MSGestureChange", r, !1), e.addEventListener("MSGestureEnd", l, !1)) : e.addEventListener("touchstart", t, !1)
            }, resize: function () {
                !s.animating && s.is(":visible") && (u || s.doMath(), p ? f.smoothHeight() : u ? (s.slides.width(s.computedW), s.update(s.pagingCount), s.setProps()) : d ? (s.viewport.height(s.h), s.setProps(s.h, "setTotal")) : (s.vars.smoothHeight && f.smoothHeight(), s.newSlides.width(s.computedW), s.setProps(s.computedW, "setTotal")))
            }, smoothHeight: function (t) {
                if (!d || p) {
                    var e = p ? s : s.viewport;
                ...
                visProp: null, init: function () {
                    ...
                    if (f.pauseInvisible.visProp) {
                        ...
                        document.addEventListener(i, function () {
                            f.pauseInvisible.isHidden() ? s.startTimeout ? clearTimeout(s.startTimeout) : s.pause() : s.started ? s.play() : s.vars.initDelay > 0 ? setTimeout(s.play, s.vars.initDelay) : s.play()
                        })
                    }
                }, isHidden: function () {
        ...
        }, s.flexAnimate = function (e, i, n, o, l) {
            if (s.vars.animationLoop || e === s.currentSlide || (s.direction = e > s.currentSlide ? "next" : "prev"), m && 1 === s.pagingCount && (s.direction = s.currentItem < e ? "next" : "prev"), !s.animating && (s.canAdvance(e, l) || n) && s.is(":visible")) {
                if (m && o) {
                    var h = t(s.vars.asNavFor).data("flexslider");
                    if (s.atEnd = 0 === e || e === s.count - 1, h.flexAnimate(e, !0, !1, !0, l), s.direction = s.currentItem < e ? "next" : "prev", h.direction = s.direction, Math.ceil((e + 1) / s.visible) - 1 === s.currentSlide || 0 === e) return s.currentItem = e, s.slides.removeClass(a + "active-slide").eq(e).addClass(a + "active-slide"), !1;
                    s.currentItem = e, s.slides.removeClass(a + "active-slide").eq(e).addClass(a + "active-slide"), e = Math.floor(e / s.visible)
                }
                if (s.animating = !0, s.animatingTo = e, i && s.pause(), s.vars.before(s), s.syncExists && !l && f.sync("animate"), s.vars.controlNav && f.controlNav.active(), u || s.slides.removeClass(a + "active-slide").eq(e).addClass(a + "active-slide"), s.atEnd = 0 === e || e === s.last, s.vars.directionNav && f.directionNav.update(), e === s.last && (s.vars.end(s), s.vars.animationLoop || s.pause()), p) r ? (s.slides.eq(s.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), s.slides.eq(e).css({
                    opacity: 1,
                    ...
                    var v, g, y, b = d ? s.slides.filter(":first").height() : s.computedW;
                    u ? (v = s.vars.itemMargin, y = (s.itemW + v) * s.move * s.animatingTo, g = y > s.limit && 1 !== s.visible ? s.limit : y) : g = 0 === s.currentSlide && e === s.count - 1 && s.vars.animationLoop && "next" !== s.direction ? c ? (s.count + s.cloneOffset) * b : 0 : s.currentSlide === s.last && 0 === e && s.vars.animationLoop && "prev" !== s.direction ? c ? 0 : (s.count + 1) * b : c ? (s.count - 1 - e + s.cloneOffset) * b : (e + s.cloneOffset) * b, s.setProps(g, "", s.vars.animationSpeed), s.transitions ? (s.vars.animationLoop && s.atEnd || (s.animating = !1, s.currentSlide = s.animatingTo), s.container.unbind("webkitTransitionEnd transitionend"), s.container.bind("webkitTransitionEnd transitionend", function () {
                ...
                s.vars.smoothHeight && f.smoothHeight(s.vars.animationSpeed)
            }
        }, s.wrapup = function (t) {
            p || u || (0 === s.currentSlide && s.animatingTo === s.last && s.vars.animationLoop ? s.setProps(t, "jumpEnd") : s.currentSlide === s.last && 0 === s.animatingTo && s.vars.animationLoop && s.setProps(t, "jumpStart")), s.animating = !1, s.currentSlide = s.animatingTo, s.vars.after(s)
        }, s.animateSlides = function () {
            !s.animating && v && s.flexAnimate(s.getTarget("next"))
        }, s.pause = function () {
            clearInterval(s.animatedSlides), s.animatedSlides = null, s.playing = !1, s.vars.pausePlay && f.pausePlay.update("play"), s.syncExists && f.sync("pause")
        }, s.play = function () {
            s.playing && clearInterval(s.animatedSlides), s.animatedSlides = s.animatedSlides || setInterval(s.animateSlides, s.vars.slideshowSpeed), s.started = s.playing = !0, s.vars.pausePlay && f.pausePlay.update("pause"), s.syncExists && f.sync("play")
        }, s.stop = function () {
            s.pause(), s.stopped = !0
            ...
            var n = function () {
                var i = t ? t : (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo, n = function () {
                    if (u) return "setTouch" === e ? t : c && s.animatingTo === s.last ? 0 : c ? s.limit - (s.itemW + s.vars.itemMargin) * s.move * s.animatingTo : s.animatingTo === s.last ? s.limit : i;
                    switch (e) {
                        case"setTotal":
                            return c ? (s.count - 1 - s.currentSlide + s.cloneOffset) * t : (s.currentSlide + s.cloneOffset) * t;
                        case"setTouch":
                            return c ? t : t;
                        case"jumpEnd":
                            return c ? t : s.count * t;
                        case"jumpStart":
                            return c ? s.count * t : t;
                        default:
                            return t
                    }
                }();
            ...
            if (p) s.slides.css({
                ...
                "init" === e && (s.viewport = t('<div class="' + a + 'viewport"></div>').css({
                    ...
                    s.doMath(), s.newSlides.css({
                        ...
                        "float": "left",
                        display: "block"
                    }), s.vars.smoothHeight && f.smoothHeight()
                }, "init" === e ? 100 : 0))
            }
            u || s.slides.removeClass(a + "active-slide").eq(s.currentSlide).addClass(a + "active-slide"), s.vars.init(s)
        }, s.doMath = function () {
            var t = s.slides.first(), e = s.vars.itemMargin, i = s.vars.minItems, n = s.vars.maxItems;
            s.w = void 0 === s.viewport ? s.width() : s.viewport.width(), s.h = t.height(), s.boxPadding = t.outerWidth() - t.width(), u ? (s.itemT = s.vars.itemWidth + e, s.minW = i ? i * s.itemT : s.w, s.maxW = n ? n * s.itemT - e : s.w, s.itemW = s.minW > s.w ? (s.w - e * (i - 1)) / i : s.maxW < s.w ? (s.w - e * (n - 1)) / n : s.vars.itemWidth > s.w ? s.w : s.vars.itemWidth, s.visible = Math.floor(s.w / s.itemW), s.move = s.vars.move > 0 && s.vars.move < s.visible ? s.vars.move : s.visible, s.pagingCount = Math.ceil((s.count - s.visible) / s.move + 1), s.last = s.pagingCount - 1, s.limit = 1 === s.pagingCount ? 0 : s.vars.itemWidth > s.w ? s.itemW * (s.count - 1) + e * (s.count - 1) : (s.itemW + e) * s.count - s.w - e) : (s.itemW = s.w, s.pagingCount = s.count, s.last = s.count - 1), s.computedW = s.itemW - s.boxPadding
        }, s.update = function (t, e) {
            s.doMath(), u || (t < s.currentSlide ? s.currentSlide += 1 : t <= s.currentSlide && 0 !== t && (s.currentSlide -= 1), s.animatingTo = s.currentSlide), s.vars.controlNav && !s.manualControls && ("add" === e && !u || s.pagingCount > s.controlNav.length ? f.controlNav.update("add") : ("remove" === e && !u || s.pagingCount < s.controlNav.length) && (u && s.currentSlide > s.last && (s.currentSlide -= 1, s.animatingTo -= 1), f.controlNav.update("remove", s.last))), s.vars.directionNav && f.directionNav.update()
        }, s.addSlide = function (e, i) {
            var n = t(e);
            s.count += 1, s.last = s.count - 1, d && c ? void 0 !== i ? s.slides.eq(s.count - i).after(n) : s.container.prepend(n) : void 0 !== i ? s.slides.eq(i).before(n) : s.container.append(n), s.update(i, "add"), s.slides = t(s.vars.selector + ":not(.clone)", s), s.setup(), s.vars.added(s)
        }, s.removeSlide = function (e) {
            var i = isNaN(e) ? s.slides.index(t(e)) : e;
            s.count -= 1, s.last = s.count - 1, isNaN(e) ? t(e, s.slides).remove() : d && c ? s.slides.eq(s.last).remove() : s.slides.eq(e).remove(), s.doMath(), s.update(i, "remove"), s.slides = t(s.vars.selector + ":not(.clone)", s), s.setup(), s.vars.removed(s)
        }, f.init()
    ...
    t.fn.jPlayer = function (i) {
        var s = "jPlayer", n = "string" == typeof i, a = Array.prototype.slice.call(arguments, 1), o = this;
        return i = !n && a.length ? t.extend.apply(null, [!0, i].concat(a)) : i, n && "_" === i.charAt(0) ? o : (this.each(n ? function () {
            var n = t(this).data(s), r = n && t.isFunction(n[i]) ? n[i].apply(n, a) : n;
            return r !== n && r !== e ? (o = r, !1) : void 0
        } : function () {
            var e = t(this).data(s);
    ...
    i.prototype = {
        init: function () {
            ...
            var e = new Date(1e3 * t), i = e.getUTCHours(),
                ...
                a = this.options.timeFormat.padHour && 10 > i ? "0" + i : i,
                o = this.options.timeFormat.padMin && 10 > s ? "0" + s : s,
                r = this.options.timeFormat.padSec && 10 > n ? "0" + n : n, l = "";
    ...
    t.jPlayer.convertTime = function (t) {
        ...
        var e = t.toLowerCase(), i = /(webkit)[ \/]([\w.]+)/, s = /(opera)(?:.*version)?[ \/]([\w.]+)/,
            n = /(msie) ([\w.]+)/, a = /(mozilla)(?:.*? rv:([\w.]+))?/,
            o = i.exec(e) || s.exec(e) || n.exec(e) || e.indexOf("compatible") < 0 && a.exec(e) || [];
        return {browser: o[1] || "", version: o[2] || "0"}
    }, t.jPlayer.uaPlatform = function (t) {
        var e = t.toLowerCase(), i = /(ipad|iphone|ipod|android|blackberry|playbook|windows ce|webos)/,
            s = /(ipad|playbook)/, n = /(android)/, a = /(mobile)/, o = i.exec(e) || [],
            r = s.exec(e) || !a.exec(e) && n.exec(e) || [];
    ...
    a.platform && (t.jPlayer.platform[a.platform] = !0, t.jPlayer.platform.mobile = !a.tablet, t.jPlayer.platform.tablet = !!a.tablet), t.jPlayer.getDocMode = function () {
        ...
        init: function () {
            var t, e, i, s = document, n = s.createElement("video"), a = {
            ...
            for (this.fullscreen = t = {
                support: {
                    w3c: !!s[a.w3c[0]],
                    moz: !!s[a.moz[0]],
                    webkit: "function" == typeof s[a.webkit[3]],
                    webkitVideo: "function" == typeof n[a.webkitVideo[2]]
                }, used: {}
    ...
    var o = function (e) {
        ...
        s && (t.each(t.jPlayer.keyIgnoreElementNames.split(/\s+/g), function (t, s) {
            ...
            return n && t.isFunction(n.fn) && ("number" == typeof n.key && e.which === n.key || "string" == typeof n.key && e.key === n.key) ? (e.preventDefault(), n.fn(s), !1) : void 0
        }))
    };
    t.jPlayer.keys = function (e) {
        ...
        count: 0,
        version: {script: "2.8.3", needFlash: "2.8.3", flash: "unknown"},
        options: {
            swfPath: "js",
            solution: "html, flash",
            supplied: "mp3",
            ...
            keyBindings: {
                play: {
                    ...
                    key: 190, fn: function (t) {
                        t.volume(t.options.volume + .1)
                    }
                }, volumeDown: {
                    key: 188, fn: function (t) {
                        t.volume(t.options.volume - .1)
                    }
                }, loop: {
        ...
        _init: function () {
            ...
            if (this.element.empty(), this.status = t.extend({}, this.status), this.internal = t.extend({}, this.internal), this.options.timeFormat = t.extend({}, t.jPlayer.timeFormat, this.options.timeFormat), this.internal.cmdsIgnored = t.jPlayer.platform.ipad || t.jPlayer.platform.iphone || t.jPlayer.platform.ipod, this.internal.domNode = this.element.get(0), this.options.keyEnabled && !t.jPlayer.focus && (t.jPlayer.focus = this), this.androidFix = {
                ...
                i.options[t] !== e && (i.element.bind(s + ".jPlayer", i.options[t]), i.options[t] = e)
            ...
            }), this.html.desired = !1, this.flash.desired = !1, t.each(this.solutions, function (e, s) {
                if (0 === e) i[s].desired = !0; else {
                    var n = !1, a = !1;
                    t.each(i.formats, function (t, e) {
                        i[i.solutions[0]].canPlay[e] && ("video" === i.format[e].media ? a = !0 : n = !0)
                    }), i[s].desired = i.require.audio && !n || i.require.video && !a
                }
            ...
            }), this.html.used = !1, this.flash.used = !1, t.each(this.solutions, function (e, s) {
                t.each(i.formats, function (t, e) {
                ...
                var s,
                    n = "jQuery=" + encodeURI(this.options.noConflict) + "&id=" + encodeURI(this.internal.self.id) + "&vol=" + this.options.volume + "&muted=" + this.options.muted;
                if (t.jPlayer.browser.msie && (Number(t.jPlayer.browser.version) < 9 || t.jPlayer.browser.documentMode < 9)) {
                    var a = '<object id="' + this.internal.flash.id + '" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="0" height="0" tabindex="-1"></object>',
                        o = ['<param name="movie" value="' + this.internal.flash.swf + '" />', '<param name="FlashVars" value="' + n + '" />', '<param name="allowScriptAccess" value="always" />', '<param name="bgcolor" value="' + this.options.backgroundColor + '" />', '<param name="wmode" value="' + this.options.wmode + '" />'];
                    s = document.createElement(a);
                    for (var r = 0; r < o.length; r++) s.appendChild(document.createElement(o[r]))
                } else {
                    var l = function (t, e, i) {
                        var s = document.createElement("param");
                        s.setAttribute("name", e), s.setAttribute("value", i), t.appendChild(s)
                    };
                    s = document.createElement("object"), s.setAttribute("id", this.internal.flash.id), s.setAttribute("name", this.internal.flash.id), s.setAttribute("data", this.internal.flash.swf), s.setAttribute("type", "application/x-shockwave-flash"), s.setAttribute("width", "1"), s.setAttribute("height", "1"), s.setAttribute("tabindex", "-1"), l(s, "flashvars", n), l(s, "allowscriptaccess", "always"), l(s, "bgcolor", this.options.backgroundColor), l(s, "wmode", this.options.wmode)
                }
        ...
        _uaBlocklist: function (e) {
            var i = navigator.userAgent.toLowerCase(), s = !1;
        ...
        _addHtmlEventListeners: function (e, i) {
            ...
            e.preload = this.options.preload, e.muted = this.options.muted, e.volume = this.options.volume, this.status.playbackRateEnabled && (e.defaultPlaybackRate = this.options.defaultPlaybackRate, e.playbackRate = this.options.playbackRate), e.addEventListener("progress", function () {
                i.gate && (s.internal.cmdsIgnored && this.readyState > 0 && (s.internal.cmdsIgnored = !1), s._getHtmlStatus(e), s._updateInterface(), s._trigger(t.jPlayer.event.progress))
            }, !1), e.addEventListener("loadeddata", function () {
                i.gate && (s.androidFix.setMedia = !1, s.androidFix.play && (s.androidFix.play = !1, s.play(s.androidFix.time)), s.androidFix.pause && (s.androidFix.pause = !1, s.pause(s.androidFix.time)), s._trigger(t.jPlayer.event.loadeddata))
            }, !1), e.addEventListener("timeupdate", function () {
                i.gate && (s._getHtmlStatus(e), s._updateInterface(), s._trigger(t.jPlayer.event.timeupdate))
            }, !1), e.addEventListener("durationchange", function () {
                i.gate && (s._getHtmlStatus(e), s._updateInterface(), s._trigger(t.jPlayer.event.durationchange))
            }, !1), e.addEventListener("play", function () {
                i.gate && (s._updateButtons(!0), s._html_checkWaitForPlay(), s._trigger(t.jPlayer.event.play))
            }, !1), e.addEventListener("playing", function () {
                i.gate && (s._updateButtons(!0), s._seeked(), s._trigger(t.jPlayer.event.playing))
            }, !1), e.addEventListener("pause", function () {
                i.gate && (s._updateButtons(!1), s._trigger(t.jPlayer.event.pause))
                ...
                i.gate && (s.options.volume = e.volume, s.options.muted = e.muted, s._updateMute(), s._updateVolume(), s._trigger(t.jPlayer.event.volumechange))
            }, !1), e.addEventListener("ratechange", function () {
                i.gate && (s.options.defaultPlaybackRate = e.defaultPlaybackRate, s.options.playbackRate = e.playbackRate, s._updatePlaybackRate(), s._trigger(t.jPlayer.event.ratechange))
            }, !1), e.addEventListener("suspend", function () {
                i.gate && (s._seeked(), s._trigger(t.jPlayer.event.suspend))
            }, !1), e.addEventListener("ended", function () {
                i.gate && (t.jPlayer.browser.webkit || (s.htmlElement.media.currentTime = 0), s.htmlElement.media.pause(), s._updateButtons(!1), s._getHtmlStatus(e, !0), s._updateInterface(), s._trigger(t.jPlayer.event.ended))
            ...
            }, !1), t.each(t.jPlayer.htmlEvent, function (n, a) {
                e.addEventListener(this, function () {
                    i.gate && s._trigger(t.jPlayer.event[a])
                }, !1)
            })
        },
        _getHtmlStatus: function (t, e) {
            var i = 0, s = 0, n = 0, a = 0;
            isFinite(t.duration) && (this.status.duration = t.duration), i = t.currentTime, s = this.status.duration > 0 ? 100 * i / this.status.duration : 0, "object" == typeof t.seekable && t.seekable.length > 0 ? (n = this.status.duration > 0 ? 100 * t.seekable.end(t.seekable.length - 1) / this.status.duration : 100, a = this.status.duration > 0 ? 100 * t.currentTime / t.seekable.end(t.seekable.length - 1) : 0) : (n = 100, a = s), e && (i = 0, a = 0, s = 0), this.status.seekPercent = n, this.status.currentPercentRelative = a, this.status.currentPercentAbsolute = s, this.status.currentTime = i, this.status.remaining = this.status.duration - this.status.currentTime, this.status.videoWidth = t.videoWidth, this.status.videoHeight = t.videoHeight, this.status.readyState = t.readyState, this.status.networkState = t.networkState, this.status.playbackRate = t.playbackRate, this.status.ended = t.ended
        },
        ...
        _trigger: function (e, i, s) {
            var n = t.Event(e);
            n.jPlayer = {}, n.jPlayer.version = t.extend({}, this.version), n.jPlayer.options = t.extend(!0, {}, this.options), n.jPlayer.status = t.extend(!0, {}, this.status), n.jPlayer.html = t.extend(!0, {}, this.html), n.jPlayer.flash = t.extend(!0, {}, this.flash), i && (n.jPlayer.error = t.extend({}, i)), s && (n.jPlayer.warning = t.extend({}, s)), this.element.trigger(n)
        },
        jPlayerFlashEvent: function (e, i) {
            if (e === t.jPlayer.event.ready) if (this.internal.ready) {
                if (this.flash.gate) {
                    if (this.status.srcSet) {
                        var s = this.status.currentTime, n = this.status.paused;
                        this.setMedia(this.status.media), this.volumeWorker(this.options.volume), s > 0 && (n ? this.pause(s) : this.play(s))
                    }
        ...
        _updateInterface: function () {
            ...
            var e = "", i = this.status.duration, s = this.status.remaining;
        ...
        play: function (t) {
            ...
            e && this.options.useStateClassSkin && !this.status.paused ? this.pause(t) : (t = "number" == typeof t ? t : 0 / 0, this.status.srcSet ? (this.focus(), this.html.active ? this._html_play(t) : this.flash.active && this._flash_play(t)) : this._urlNotSetError("play"))
        },
        videoPlay: function () {
            this.play()
        },
        ...
        tellOthers: function (e, i) {
            var s = this, n = "function" == typeof i, a = Array.prototype.slice.call(arguments);
            "string" == typeof e && (n && a.splice(1, 1), t.each(this.instances, function () {
                s.element !== this && (!n || i.call(this.data("jPlayer"), s)) && this.jPlayer.apply(this, a)
            }))
        },
        ...
        volumeBar: function (e) {
            if (this.css.jq.volumeBar.length) {
                var i = t(e.currentTarget), s = i.offset(), n = e.pageX - s.left, a = i.width(),
                    o = i.height() - e.pageY + s.top, r = i.height();
                this.volume(this.options.verticalVolume ? o / r : n / a)
            }
        ...
        _cssSelector: function (e, i) {
            ...
            if ("string" == typeof i) if (t.jPlayer.prototype.options.cssSelector[e]) {
                if (this.css.jq[e] && this.css.jq[e].length && this.css.jq[e].unbind(".jPlayer"), this.options.cssSelector[e] = i, this.css.cs[e] = this.options.cssSelectorAncestor + " " + i, this.css.jq[e] = i ? t(this.css.cs[e]) : [], this.css.jq[e].length && this[e]) {
                    var n = function (i) {
        ...
        seekBar: function (e) {
            if (this.css.jq.seekBar.length) {
                var i = t(e.currentTarget), s = i.offset(), n = e.pageX - s.left, a = i.width(), o = 100 * n / a;
                this.playHead(o)
            }
        },
        ...
        playbackRateBar: function (e) {
            if (this.css.jq.playbackRateBar.length) {
                var i, s, n = t(e.currentTarget), a = n.offset(), o = e.pageX - a.left, r = n.width(),
                    l = n.height() - e.pageY + a.top, h = n.height();
                i = this.options.verticalPlaybackRate ? l / h : o / r, s = i * (this.options.maxPlaybackRate - this.options.minPlaybackRate) + this.options.minPlaybackRate, this.playbackRate(s)
            }
        },
        ...
        repeat: function (t) {
            var e = "object" == typeof t;
            this._loop(e && this.options.useStateClassSkin && this.options.loop ? !1 : !0)
        },
        repeatOff: function () {
            this._loop(!1)
        },
            ...
            if ("string" == typeof i) {
                ...
                if (s === e) {
                    for (var o = t.extend(!0, {}, this.options), r = 0; r < a.length; r++) {
                        if (o[a[r]] === e) return this._warning({
                ...
                n = {};
                for (var l = n, h = 0; h < a.length; h++) h < a.length - 1 ? (l[a[h]] = {}, l = l[a[h]]) : l[a[h]] = s
            }
        ...
        _updateAutohide: function () {
            var t = this, e = "mousemove.jPlayer", i = ".jPlayerAutohide", s = e + i, n = function (e) {
                var i, s, n = !1;
                "undefined" != typeof t.internal.mouse ? (i = t.internal.mouse.x - e.pageX, s = t.internal.mouse.y - e.pageY, n = Math.floor(i) > 0 || Math.floor(s) > 0) : n = !0, t.internal.mouse = {
                    x: e.pageX,
                    y: e.pageY
            ...
            this.css.jq.gui.length && (this.css.jq.gui.stop(!0, !0), clearTimeout(this.internal.autohideId), delete this.internal.mouse, this.element.unbind(i), this.css.jq.gui.unbind(i), this.status.nativeVideoControls ? this.css.jq.gui.hide() : this.options.fullWindow && this.options.autohide.full || !this.options.fullWindow && this.options.autohide.restored ? (this.element.bind(s, n), this.css.jq.gui.bind(s, n), this.css.jq.gui.hide()) : this.css.jq.gui.show())
        },
        ...
        _html_play: function (t) {
            ...
            if (this.androidFix.pause = !1, this._html_load(), this.androidFix.setMedia) this.androidFix.play = !0, this.androidFix.time = t; else if (isNaN(t)) i.play(); else {
        ...
        _html_pause: function (t) {
            var e = this, i = this.htmlElement.media;
            if (this.androidFix.play = !1, t > 0 ? this._html_load() : clearTimeout(this.internal.htmlDlyCmdId), i.pause(), this.androidFix.setMedia) this.androidFix.pause = !0, this.androidFix.time = t; else if (!isNaN(t)) try {
                if (i.seekable && !("object" == typeof i.seekable && i.seekable.length > 0)) throw 1;
                i.currentTime = t
            } catch (s) {
                return void(this.internal.htmlDlyCmdId = setTimeout(function () {
    ...
    function i(t) {
        ...
        function n(e, i) {
            t.fn[e] = function (n) {
                if ("string" == typeof n) {
                    for (var o = s.call(arguments, 1), r = 0, l = this.length; l > r; r++) {
                        var h = this[r], d = t.data(h, e);
                        if (d) if (t.isFunction(d[n]) && "_" !== n.charAt(0)) {
                            var c = d[n].apply(d, o);
                            if (void 0 !== c) return c
                        } else a("no such method '" + n + "' for " + e + " instance"); else a("cannot call methods on " + e + " prior to initialization; attempted to call '" + n + "'")
                    }
                    return this
                }
                return this.each(function () {
    ...
    "use strict";
    var e = "selectric", i = "Input Items Open Disabled TempShow HideSelect Wrapper Hover Responsive Above Scroll",
        s = ".sl", n = {
            onChange: function (e) {
                t(e).change()
            },
            ...
            customClass: {prefix: e, postfixes: i, camelCase: !0},
            ...
            }, triggerCallback: function (i, s) {
                var n = s.element, r = s.options["on" + i];
                t.isFunction(r) && r.call(n, n, s), a[i] && t.each(a[i], function () {
                    this.call(n, n, s)
                }), t(n).trigger(e + "-" + o.toDash(i), s)
            }
        }, r = t(document), l = t(window), h = function (a, h) {
            function d(e) {
                if (L.options = t.extend(!0, {}, n, L.options, e), L.classes = {}, L.element = a, o.triggerCallback("BeforeInit", L), L.options.disableOnMobile && I) return void(L.disableOnMobile = !0);
                _(!0);
                var s = L.options.customClass, r = s.postfixes.split(" "), l = $.width();
                t.each(i.split(" "), function (t, e) {
                    var i = s.prefix + r[t];
                    L.classes[e.toLowerCase()] = s.camelCase ? i : o.toDash(i)
                }), w = t("<input/>", {"class": L.classes.input, readonly: I}), P = t("<div/>", {
                    "class": L.classes.items,
                    tabindex: -1
                }), C = t("<div/>", {"class": L.classes.scroll}), S = t("<div/>", {
                    "class": s.prefix,
                    html: L.options.arrowButtonMarkup
                }), j = t('<p class="label"/>'), E = $.wrap("<div>").parent().append(S.prepend(j), P, w), M = {
                    open: f,
                    close: g,
                    destroy: _,
                    refresh: u,
                    init: d
                }, $.on(M).wrap('<div class="' + L.classes.hideselect + '">'), t.extend(L, M), L.options.inheritOriginalWidth && l > 0 && E.width(l), c()
            }

            function c() {
                L.items = [];
                var i = $.children(), n = "<ul>", a = i.filter(":selected").index();
                T = x = ~a ? a : 0, (F = i.length) && (i.each(function (e) {
                    var i = t(this), s = i.html(), a = i.prop("disabled"), r = L.options.optionsItemBuilder;
                    L.items[e] = {
                        value: i.val(),
                        text: s,
                        slug: o.replaceDiacritics(s),
                        disabled: a
                    }, n += o.format('<li class="{1}">{2}</li>', t.trim([e == T ? "selected" : "", e == F - 1 ? "last" : "", a ? "disabled" : ""].join(" ")), t.isFunction(r) ? r(L.items[e], i, e) : o.format(r, L.items[e]))
                }), P.append(C.html(n + "</ul>")), j.html(L.items[T].text)), S.add($).add(E).add(w).off(s), E.prop("class", [L.classes.wrapper, $.prop("class").replace(/\S+/g, e + "-$&"), L.options.responsive ? L.classes.responsive : ""].join(" ")), $.prop("disabled") ? (E.addClass(L.classes.disabled), w.prop("disabled", !0)) : (R = !0, E.removeClass(L.classes.disabled).on("mouseenter" + s + " mouseleave" + s, function (e) {
                    t(this).toggleClass(L.classes.hover), L.options.openOnHover && (clearTimeout(L.closeTimer), "mouseleave" == e.type ? L.closeTimer = setTimeout(g, 500) : f())
                }), S.on("click" + s, function (t) {
                    A ? g() : f(t)
                }), w.prop({tabindex: D, disabled: !1}).on("keypress" + s, p).on("keydown" + s, function (t) {
                    p(t), clearTimeout(L.resetStr), L.resetStr = setTimeout(function () {
                        w.val("")
                    }, L.options.keySearchTimeout);
                    var e = t.keyCode || t.which;
                    e > 36 && 41 > e && y(o[(39 > e ? "previous" : "next") + "EnabledItem"](L.items, x))
                }).on("focusin" + s, function (t) {
                    w.one("blur", function () {
                        w.blur()
                    }), A || f(t)
                }).on("oninput" in w[0] ? "input" : "keyup", function () {
                    w.val().length && t.each(L.items, function (t, e) {
                        return RegExp("^" + w.val(), "i").test(e.slug) && !e.disabled ? (y(t), !1) : void 0
                    })
                }), $.prop("tabindex", !1), k = t("li", P.removeAttr("style")).click(function () {
                    return y(t(this).index(), !0), !1
                })), o.triggerCallback("Init", L)
            }

            function u() {
                o.triggerCallback("Refresh", L), c()
            }

            function p(t) {
                var e = t.keyCode || t.which;
                13 == e && t.preventDefault(), /^(9|13|27)$/.test(e) && (t.stopPropagation(), y(x, !0))
            }

            function m() {
                var t = P.closest(":visible").children(":hidden"), e = L.options.maxHeight;
                t.addClass(L.classes.tempshow);
                var i = P.outerWidth(), s = S.outerWidth() - (i - P.width());
                !L.options.expandToItemText || s > i ? N = s : (P.css("overflow", "scroll"), E.width(9e4), N = P.width(), P.css("overflow", ""), E.width("")), P.width(N).height() > e && P.height(e), t.removeClass(L.classes.tempshow)
            }

            function f(i) {
                o.triggerCallback("BeforeOpen", L), i && (i.preventDefault(), i.stopPropagation()), R && (m(), t("." + L.classes.hideselect, "." + L.classes.open).children()[e]("close"), A = !0, q = P.outerHeight(), O = P.height(), w.val("").is(":focus") || w.focus(), r.on("click" + s, g).on("scroll" + s, v), v(), L.options.preventWindowScroll && r.on("mousewheel" + s + " DOMMouseScroll" + s, "." + L.classes.scroll, function (e) {
                    var i = e.originalEvent, s = t(this).scrollTop(), n = 0;
                    "detail" in i && (n = -1 * i.detail), "wheelDelta" in i && (n = i.wheelDelta), "wheelDeltaY" in i && (n = i.wheelDeltaY), "deltaY" in i && (n = -1 * i.deltaY), (s == this.scrollHeight - O && 0 > n || 0 == s && n > 0) && e.preventDefault()
                }), E.addClass(L.classes.open), b(x), o.triggerCallback("Open", L))
            }

            function v() {
                m(), E.toggleClass(L.classes.above, E.offset().top + E.outerHeight() + q > l.scrollTop() + l.height())
            }

            function g() {
                if (o.triggerCallback("BeforeClose", L), T != x) {
                    o.triggerCallback("BeforeChange", L);
                    var t = L.items[x].text;
                    $.prop("selectedIndex", T = x).data("value", t), j.html(t), o.triggerCallback("Change", L)
                }
                r.off(s), E.removeClass(L.classes.open), A = !1, o.triggerCallback("Close", L)
            }

            function y(t, e) {
                L.items[x = t].disabled || (k.removeClass("selected").eq(t).addClass("selected"), b(t), e && g())
            }

            function b(t) {
                var e = k.eq(t).outerHeight(), i = k[t].offsetTop, s = C.scrollTop(), n = i + 2 * e;
                C.scrollTop(n > s + q ? n - q : s > i - e ? i - e : s)
            }

            function _(t) {
                R && (P.add(S).add(w).remove(), !t && $.removeData(e).removeData("value"), $.prop("tabindex", D).off(s).off(M).unwrap().unwrap(), R = !1)
            }

            var w, P, C, S, j, E, k, x, T, q, O, N, F, M, L = this, $ = t(a), A = !1, R = !1,
                I = /android|ip(hone|od|ad)/i.test(navigator.userAgent), D = $.prop("tabindex");
            d(h)
        };
    t.fn[e] = function (i) {
        return this.each(function () {
            var s = t.data(this, e);
            s && !s.disableOnMobile ? "" + i === i && s[i] ? s[i]() : s.init(i) : t.data(this, e, new h(this, i))
        })
    }, t.fn[e].hooks = a
}(jQuery), function (t, e) {
    ...
    return function (t) {
        ...
        function i(e, i) {
            function s(t, e) {
                var i = "data-slider-" + e, s = t.getAttribute(i);
                try {
                    return JSON.parse(s)
                } catch (n) {
                    return s
            ...
            var n, a, o, r = this.element.style.width, l = !1, h = this.element.parentNode;
            if (this.sliderElem) l = !0; else {
                this.sliderElem = document.createElement("div"), this.sliderElem.className = "slider";
                var d = document.createElement("div");
                d.className = "slider-track", n = document.createElement("div"), n.className = "slider-selection", a = document.createElement("div"), a.className = "slider-handle min-slider-handle", o = document.createElement("div"), o.className = "slider-handle max-slider-handle", d.appendChild(n), d.appendChild(a), d.appendChild(o);
                var c = function (t) {
                    var e = document.createElement("div");
                ...
                u.className = "tooltip tooltip-main", c(u);
                var p = document.createElement("div");
                p.className = "tooltip tooltip-min", c(p);
                var m = document.createElement("div");
                m.className = "tooltip tooltip-max", c(m), this.sliderElem.appendChild(d), this.sliderElem.appendChild(u), this.sliderElem.appendChild(p), this.sliderElem.appendChild(m), h.insertBefore(this.sliderElem, this.element), this.element.style.display = "none"
            }
            t && (this.$element = t(this.element), this.$sliderElem = t(this.sliderElem)), i = i ? i : {};
            for (var f = Object.keys(this.defaultOptions), v = 0; v < f.length; v++) {
                var g = f[v], y = i[g];
                y = "undefined" != typeof y ? y : s(this.element, g), y = null !== y ? y : this.defaultOptions[g], this.options || (this.options = {}), this.options[g] = y
            }
            ...
            }, this)), "vertical" === this.options.orientation ? (this._addClass(this.sliderElem, "slider-vertical"), this.stylePos = "top", this.mousePos = "pageY", this.sizePos = "offsetHeight", this._addClass(this.tooltip, "right"), this.tooltip.style.left = "100%", this._addClass(this.tooltip_min, "right"), this.tooltip_min.style.left = "100%", this._addClass(this.tooltip_max, "right"), this.tooltip_max.style.left = "100%") : (this._addClass(this.sliderElem, "slider-horizontal"), this.sliderElem.style.width = r, this.options.orientation = "horizontal", this.stylePos = "left", this.mousePos = "pageX", this.sizePos = "offsetWidth", this._addClass(this.tooltip, "top"), this.tooltip.style.top = -this.tooltip.outerHeight - 14 + "px", this._addClass(this.tooltip_min, "top"), this.tooltip_min.style.top = -this.tooltip_min.outerHeight - 14 + "px", this._addClass(this.tooltip_max, "top"), this.tooltip_max.style.top = -this.tooltip_max.outerHeight - 14 + "px"), this.options.value instanceof Array ? this.options.range = !0 : this.options.range && (this.options.value = [this.options.value, this.options.max]), this.trackSelection = n || this.trackSelection, "none" === this.options.selection && this._addClass(this.trackSelection, "hide"), this.handle1 = a || this.handle1, this.handle2 = o || this.handle2, l === !0 && (this._removeClass(this.handle1, "round triangle"), this._removeClass(this.handle2, "round triangle hide"));
            var b = ["round", "triangle", "custom"], _ = -1 !== b.indexOf(this.options.handle);
            _ && (this._addClass(this.handle1, this.options.handle), this._addClass(this.handle2, this.options.handle)), this.offset = this._offset(this.sliderElem), this.size = this.sliderElem[this.sizePos], this.setValue(this.options.value), this.handle1Keydown = this._keydown.bind(this, 0), this.handle1.addEventListener("keydown", this.handle1Keydown, !1), this.handle2Keydown = this._keydown.bind(this, 1), this.handle2.addEventListener("keydown", this.handle2Keydown, !1), this.touchCapable ? (this.mousedown = this._mousedown.bind(this), this.sliderElem.addEventListener("touchstart", this.mousedown, !1)) : (this.mousedown = this._mousedown.bind(this), this.sliderElem.addEventListener("mousedown", this.mousedown, !1)), "hide" === this.options.tooltip ? (this._addClass(this.tooltip, "hide"), this._addClass(this.tooltip_min, "hide"), this._addClass(this.tooltip_max, "hide")) : "always" === this.options.tooltip ? (this._showTooltip(), this._alwaysShowTooltip = !0) : (this.showTooltip = this._showTooltip.bind(this), this.hideTooltip = this._hideTooltip.bind(this), this.sliderElem.addEventListener("mouseenter", this.showTooltip, !1), this.sliderElem.addEventListener("mouseleave", this.hideTooltip, !1), this.handle1.addEventListener("focus", this.showTooltip, !1), this.handle1.addEventListener("blur", this.hideTooltip, !1), this.handle2.addEventListener("focus", this.showTooltip, !1), this.handle2.addEventListener("blur", this.hideTooltip, !1)), this.options.enabled ? this.enable() : this.disable()
        }
        ...
        if (e = function (t, e) {
            ...
            setValue: function (t, e) {
                t || (t = 0), this.options.value = this._validateInputValue(t);
                var i = this._applyPrecision.bind(this);
                this.options.range ? (this.options.value[0] = i(this.options.value[0]), this.options.value[1] = i(this.options.value[1]), this.options.value[0] = Math.max(this.options.min, Math.min(this.options.max, this.options.value[0])), this.options.value[1] = Math.max(this.options.min, Math.min(this.options.max, this.options.value[1]))) : (this.options.value = i(this.options.value), this.options.value = [Math.max(this.options.min, Math.min(this.options.max, this.options.value))], this._addClass(this.handle2, "hide"), this.options.value[1] = "after" === this.options.selection ? this.options.max : this.options.min), this.diff = this.options.max - this.options.min, this.percentage = this.diff > 0 ? [100 * (this.options.value[0] - this.options.min) / this.diff, 100 * (this.options.value[1] - this.options.min) / this.diff, 100 * this.options.step / this.diff] : [0, 0, 100], this._layout();
                var s = this.options.range ? this.options.value : this.options.value[0];
                return this._setDataVal(s), e === !0 && this._trigger("slide", s), this
            },
            destroy: function () {
            ...
            on: function (e, i) {
                return t ? (this.$element.on(e, i), this.$sliderElem.on(e, i)) : this._bindNonQueryEventHandler(e, i), this
            },
            ...
            _layout: function () {
                var t;
                if (t = this.options.reversed ? [100 - this.percentage[0], this.percentage[1]] : [this.percentage[0], this.percentage[1]], this.handle1.style[this.stylePos] = t[0] + "%", this.handle2.style[this.stylePos] = t[1] + "%", "vertical" === this.options.orientation) this.trackSelection.style.top = Math.min(t[0], t[1]) + "%", this.trackSelection.style.height = Math.abs(t[0] - t[1]) + "%"; else {
                    this.trackSelection.style.left = Math.min(t[0], t[1]) + "%", this.trackSelection.style.width = Math.abs(t[0] - t[1]) + "%";
                    var e = this.tooltip_min.getBoundingClientRect(), i = this.tooltip_max.getBoundingClientRect();
                    e.right > i.left ? (this._removeClass(this.tooltip_max, "top"), this._addClass(this.tooltip_max, "bottom"), this.tooltip_max.style.top = "18px") : (this._removeClass(this.tooltip_max, "bottom"), this._addClass(this.tooltip_max, "top"), this.tooltip_max.style.top = "-30px")
                }
                var s;
                if (this.options.range) {
                    s = this.options.formatter(this.options.value), this._setText(this.tooltipInner, s), this.tooltip.style[this.stylePos] = (t[1] + t[0]) / 2 + "%", "vertical" === this.options.orientation ? this._css(this.tooltip, "margin-top", -this.tooltip.offsetHeight / 2 + "px") : this._css(this.tooltip, "margin-left", -this.tooltip.offsetWidth / 2 + "px"), "vertical" === this.options.orientation ? this._css(this.tooltip, "margin-top", -this.tooltip.offsetHeight / 2 + "px") : this._css(this.tooltip, "margin-left", -this.tooltip.offsetWidth / 2 + "px");
                    var n = this.options.formatter(this.options.value[0]);
                    this._setText(this.tooltipInner_min, n);
                    var a = this.options.formatter(this.options.value[1]);
                    this._setText(this.tooltipInner_max, a), this.tooltip_min.style[this.stylePos] = t[0] + "%", "vertical" === this.options.orientation ? this._css(this.tooltip_min, "margin-top", -this.tooltip_min.offsetHeight / 2 + "px") : this._css(this.tooltip_min, "margin-left", -this.tooltip_min.offsetWidth / 2 + "px"), this.tooltip_max.style[this.stylePos] = t[1] + "%", "vertical" === this.options.orientation ? this._css(this.tooltip_max, "margin-top", -this.tooltip_max.offsetHeight / 2 + "px") : this._css(this.tooltip_max, "margin-left", -this.tooltip_max.offsetWidth / 2 + "px")
                } else s = this.options.formatter(this.options.value[0]), this._setText(this.tooltipInner, s), this.tooltip.style[this.stylePos] = t[0] + "%", "vertical" === this.options.orientation ? this._css(this.tooltip, "margin-top", -this.tooltip.offsetHeight / 2 + "px") : this._css(this.tooltip, "margin-left", -this.tooltip.offsetWidth / 2 + "px")
            },
            ...
            _mousedown: function (t) {
                ...
                if (this.options.range) {
                    var i = Math.abs(this.percentage[0] - e), s = Math.abs(this.percentage[1] - e);
                ...
                return this._trigger("slideStart", n), this._setDataVal(n), this.setValue(n), this._pauseEvent(t), !0
            },
            ...
            _keydown: function (t, e) {
                ...
                if (i) {
                    ...
                    var a = i * this.percentage[2], o = this.percentage[t] + a;
                    o > 100 ? o = 100 : 0 > o && (o = 0), this.dragged = t, this._adjustPercentageForRangeSliders(o), this.percentage[this.dragged] = o, this._layout();
                    var r = this._calculateValue();
                    return this._trigger("slideStart", r), this._setDataVal(r), this.setValue(r, !0), this._trigger("slideStop", r), this._setDataVal(r), this._pauseEvent(e), !1
                }
            },
            ...
            _setDataVal: function (t) {
                var e = "value: '" + t + "'";
                this.element.setAttribute("data", e), this.element.setAttribute("value", t)
            },
            ...
            _addClass: function (t, e) {
                for (var i = e.split(" "), s = t.className, n = 0; n < i.length; n++) {
                    var a = i[n], o = new RegExp("(?:\\s|^)" + a + "(?:\\s|$)"), r = o.test(s);
                    r || (s += " " + a)
                }
                t.className = s.trim()
            },
